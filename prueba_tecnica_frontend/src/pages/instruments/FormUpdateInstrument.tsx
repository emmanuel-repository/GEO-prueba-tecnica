...
export default function FormUpdateInstrument() {

  const navigate = useNavigate();
  const { instrumentData, updateInstrumentInList } = useMusicalInstrumentStore();
  ...
  const { refetch } = useApi(
    () => musicalInstrumentService.update(instrumentData.id!, getValues()),
    {
      onSuccess: (updated) => {
        updateInstrumentInList(updated);
        successAlert('Instrumento actualizado correctamente.');
        ...
        <Card className="w-auto">
          ...
          <CardHeader>
            <div className="flex flex-row justify-center">
              <div className="text-5xl">Editar Instrumento</div>
            </div>
          </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <Select
                      defaultValue={String(instrumentData.categoryId)}
